...
(function() {
  ...
  $(function() {
    var dialog, indicateSelected, initialize, loadFiles, refreshFiles, setProgress, sizeColumns, tableSetup, toHiddenFields;
    ...
    setProgress = function(done) {
      ...
      return $('#loading_progress').attr('aria-valuenow', done);
    };
    ...
    $(document).on('click', '.ev-files table tr', function(event) {
      if (event.target.nodeName !== 'A') {
        return $('a.ev-link', this).click();
      }
    });
    ...
    $(document).on('click', '.ev-file a', function(event) {
      var count, file_location, files, hidden_input, target, target_form;
      event.preventDefault();
    ...
    return $(document).on('click', '.ev-auth', function(event) {
